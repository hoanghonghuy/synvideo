...
var (
	...
	ErrContentUnsupported       = errors.New("media asset content type is unsupported")
	ErrContentMalformed         = errors.New("media asset content is malformed")
	ErrContentMismatch          = errors.New("media asset content does not match declared type")
	ErrContentValidationTimeout = errors.New("media asset content validation timed out")
	ErrContentValidationFailed  = errors.New("media asset content validation failed")
)
