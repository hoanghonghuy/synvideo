export default {
  vi: { captions: {
    ...
    loadPending: 'Đang tải phụ đề…', derivePending: 'Đang tạo phụ đề…', savePending: 'Đang lưu phụ đề…', rebuildPending: 'Đang rebuild phụ đề…',
  ...
  en: { captions: {
    ...
    loadPending: 'Loading captions…', derivePending: 'Deriving captions…', savePending: 'Saving captions…', rebuildPending: 'Rebuilding captions…',
